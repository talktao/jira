...
export const List = ({ users, ...props }: ListProps) => {
	...
	const pinProject = (id: number) => (pin: boolean ) => mutate({id, pin}).then(props.refresh) // const pinProject = (id: number, pin: boolean) => mutate(id, pin)
	return (
			...
			columns={[
				{
					...
					render(value, project) {
						return <Pin checked={project.pin} onCheckedChange={pinProject(project.id)}/>   //onCheckedChange={pin => pinProject(project.id, pin)}
					},
				},
				{
					title: '名称',
